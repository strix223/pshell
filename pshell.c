/* Keep track of the attributes of the shell */
...
typedef struct process
{
    ...
    char completed        // true if the process has completed
    char stopped          // true if the process has stopped
...
typedef struct job
{
    ...
    char notified;             // true if user told about the stopped job
                ...
                int forground)
{
    ...
    if (shell_is_interactive)
    {
        ...
        */
        ...
        signal (SIGTOU, SIG_DFL);
        signal (SIGHLD, SIG_DFL);
    ...
    if (pid > 0)
        {
            ...
            fprint (stderr, "No child process %d.\n", pid);
            return -1;
        }
